...
## [codemod-next@1.0.0-rc.20] - 2025-07-27

### 🐛 Bug Fixes

- Fix package specification parsing to handle scoped packages correctly (#1660)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.20 (#1661)

## [codemod-next@1.0.0-rc.19] - 2025-07-27

### 🐛 Bug Fixes

- *(codemod-sandbox)* Replace row with line in JsPosition (#1655)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.19 (#1658)

## [codemod-next@1.0.0-rc.18] - 2025-07-26

### 🐛 Bug Fixes

- *(docs)* Formatting errors (#1648)
- *(docs)* Workflow docs formatting (#1649)
- *(docs)* Intro images (#1650)
- Fix package name validation in publish command to support scoped packages (#1652)

### 📚 Documentation

- Add API key docs (#1645)
- Update intro illustration (#1637)
- Add zod 3 to 4 migration guide (#1647)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.18 (#1653)

## [codemod-next@1.0.0-rc.17] - 2025-07-23

### 🚀 Features

- *(cli)* Add API key authentication to login command (#1642)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.17 (#1643)

## [codemod-next@1.0.0-rc.16] - 2025-07-22

### 🚀 Features

- *(cli)* Bundle jssg codemods pre-publish (#1639)

### 📚 Documentation

- Add CLI search reference (#1630)
- Deprecate opportunity finder & update workflows docs (#1631)
- Revamp intro & updated outdated content (#1632)
- Updates & polishes (#1634)
- Document unpublish command & add publishing examples (#1635)

### ⚙️ Miscellaneous Tasks

- Update lockfile & gitignore (#1638)
- *(bump)* Bump codemod crates version to v1.0.0-rc.16 (#1640)

## [codemod-next@1.0.0-rc.15] - 2025-07-20

### 🚀 Features

- *(codemod-sandbox)* Integrate OxcResolver for module resolution (#1627)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.15 (#1628)

## [codemod-next@1.0.0-rc.14] - 2025-07-19

### 🚀 Features

- Switch to swc_ts_fast_strip (#1624)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.14 (#1625)

## [codemod-next@1.0.0-rc.13] - 2025-07-19

### 🚀 Features

- *(cli)* Add non-interactive mode for init command (#1619)
- *(telemetry)* Add PostHog event tracking to publish and run commands (#1607)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.13 (#1623)
