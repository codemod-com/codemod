...
## [codemod-next@1.0.0-rc.3] - 2025-06-25

### 🚀 Features

- Ast-grep step type for workflows (#1548)
- Add JavaScript AST grep functionality/step action to workflows (#1550)
- Codemod CLI registry (#1551)

### ⚙️ Miscellaneous Tasks

- *(bump)* Bump codemod crates version to v1.0.0-rc.2 (#1552)
- *(release)* Update package names in CLI to use the new codemod.com namespace
- *(release)* Fix the binary npm package version bump sed command
