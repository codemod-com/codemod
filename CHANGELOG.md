...
## [codemod-next@1.0.0-rc.21] - 2025-08-02

### 🐛 Bug Fixes

- Prevent publishing codemods when jssg module resolution fails (#1663)
- Fix show `@` for scope name in search result (#1672)
- *(cli)* Update JavaScript and TypeScript templates and language handling

### 🚜 Refactor

- *(codemod-sandbox)* Simplify OxcResolver initialization (#1671)

### 📚 Documentation

- Add brunocroh as a contributor for code (#1664)
- Update dark bg color (#1665)
- Update primary and light colors in theme configuration (#1666)
- *(cli-reference)* Add running from registry (#1669)

### ⚙️ Miscellaneous Tasks

- *(docs)* Changelog update July 24 (#1651)
- Update issue templates (#1616)
- *(template)* Update (#1633)
- *(bump)* Bump codemod crates version to v1.0.0-rc.21 (#1675)
