...
export let transpile = (source: string): string => {
...
export let getTransformer: any = (source: string) => {
	type Exports =
		| {
				__esModule?: true;
				default?: unknown;
	...
	let module = { exports: {} as Exports };
	let _require = (name: string) => {
		if (name === 'ts-morph') {
			return tsmorph;
		}
	...
	let keys = ['module', 'exports', 'require'];
	let values = [module, module.exports, _require];
