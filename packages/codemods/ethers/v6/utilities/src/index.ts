export default function transform(file, api) {
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('encodeBytes32String'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('decodeBytes32String'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('dataSlice'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('zeroPadValue'));
    dirtyFlag = true;
  });
  ...
  root.find(j.MemberExpression, {
    ...
    path.replace(j.callExpression(j.memberExpression(j.identifier('AbiCoder'), j.identifier('defaultAbiCoder')), []));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('toQuantity'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('getBytes'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('solidityPacked'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('solidityPackedKeccak256'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    path.node.callee = j.memberExpression(j.identifier('ethers'), j.identifier('solidityPackedSha256'));
    dirtyFlag = true;
  });
  ...
  root.find(j.CallExpression, {
    ...
    if (args.length === 3) {
      ...
      path.replace(j.callExpression(
        j.memberExpression(j.identifier('ethers'), j.identifier('defineProperties')),
        [obj, j.objectExpression([j.property.from({ kind: 'init', key: j.identifier(key.value), value })])]
      ));
      dirtyFlag = true;
    }
  });
