...
Codemod platform allows you to easily share codemods with friends, team members, the open-source community by publishing them to [Codemod Registry](/codemod-registry/introduction).
