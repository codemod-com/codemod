...
Once your codemod package has a [valid `.codemodrc.json` file](#required-codemod-package-structure), you can use Codemod CLI to publish a local codemod to the codemod registry.
