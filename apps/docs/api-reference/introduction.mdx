...
## Tips
- Use the [public registry](https://app.codemod.com/registry) to find valid, fetchable package names.
...
- [replace-console-log example](https://app.codemod.com/registry/replace-console-log)
- [am_import-assertions-to-attributes example](https://app.codemod.com/registry/am_import-assertions-to-attributes) 