...
<Card title="Zod 3 -> 4" href="/guides/migrations/zod-3-4" icon={
  ...
  <svg
    ...
    {...props}
  >
    <path fill="url(#a)" d="M29.092 2.13H2.523v20.678h26.569V2.13Z" />
    ...
    />
    <path fill="url(#b)" d="M32 0H0v26h32V0Z" />
    <path
      fill="#3068B7"
      fillRule="evenodd"
    ...
    <defs>
      ...
      >
        <use xlinkHref="#image0_7135_13935" transform="scale(.00115 .0015)" />
      </pattern>
      <pattern
        id="b"
        width={1}
        ...
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#image1_7135_13935" transform="scale(.00096 .00119)" />
      </pattern>
    </defs>
  </svg>
  </>
