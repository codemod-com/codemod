...
- repository - [clone](/guides/engines/workflow-engine/api-reference#clone), [branch](/guides/engines/workflow-engine/api-reference#branch), [commit](/guides/engines/workflow-engine/api-reference#commit), [push](/guides/engines/workflow-engine/api-reference#push)
- directories - [iterate](/guides/engines/workflow-engine/api-reference#dirs), copy, move, remove
- files - [iterate](/guides/engines/workflow-engine/api-reference#files), copy, move, remove
- code blocks - [iterate](/guides/engines/workflow-engine/api-reference#astgrep), [change](/guides/engines/workflow-engine/api-reference/ast-grep#replace), [remove](/guides/engines/workflow-engine/api-reference/ast-grep#replace)
