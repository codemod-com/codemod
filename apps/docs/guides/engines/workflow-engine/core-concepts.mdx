---
title: Codemod Workflow Engine Core Technical Concepts
---
...
- repository - [clone](#clone), [branch](#branch), [commit](#commit), [push](#push)
- directories - [iterate](#dirs), copy, move, remove
- files - [iterate](#files), copy, move, remove
- code blocks - [iterate](#astgrep), [change](#replace), [remove](#replace)
