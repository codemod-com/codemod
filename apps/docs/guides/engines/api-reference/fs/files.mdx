...
A callback which will be executed for each file. First argument is an object with [subcommands](#returns). It can be destructured to get access to subcommands.
</ResponseField>
