...
// TODO: should this be made into a separate `.codemodrc.json` reference page/group?

A Codemod-compatible package should have a `.codemodrc.json` configuration file in the project root and conform to one of the supported engines' structures.
...
// TODO
1. Build from Codemod Studio
2. Build from `codemod learn`
3. Build from existing codemod