---
title: 'Overview'
description: 'Get started with using Codemod VS Code extension.'
icon: 'book-open-cover'
---

<img
  className="block dark:hidden"
  src="/images/deploying-codemods/vsce/codemod-vsce-light.svg"
  alt="Codemod VS Code extension hero banner"
/>

<img
  className="hidden dark:block"
  src="/images/deploying-codemods/vsce/codemod-vsce-dark.svg"
  alt="Codemod VS Code extension hero banner"
/>
...
You can install Codemod VS Code extension from the VS Code marketplace [here](https://go.codemod.com/vsce).
...
<AccordionGroup>
  <Accordion title="Switch diff view" icon="code-compare" iconType="light">
    ...
    <video
      ...
      playsInline
      className="w-full aspect-video"
      src="/images/deploying-codemods/vsce/switch-diff-view.mp4"
    ></video>
  </Accordion>
  <Accordion title="Reporting issues" icon="bug" iconType="light">
    ...
    <img
      className="hidden dark:block"
      src="/images/deploying-codemods/vsce/report-issue.png"
      alt="Codemod VS Code extension hero banner"
    />
  </Accordion>
</AccordionGroup>
