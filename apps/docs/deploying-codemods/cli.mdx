...
The `unpublish` command can be used to unpublish a codemod from Codemod Registry.
...
Or you can completely unpublish a codemod, including all versions, from the registry:
