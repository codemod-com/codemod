...
Alternatively, you can publish a codemod from a local <Tooltip tip="This file can be a simple transform file using any of the supported codemod engines.">transform file</Tooltip>:

```bash
codemod publish [path-to-file] --source
```
