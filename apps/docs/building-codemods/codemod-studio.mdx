...
<Steps>
  ...
  <Step title="Run">
    With close integration with Codemod platform, Codemod Studio allows you to easily run your codemods over your projects using the Codemod VS Code Extension.
  </Step>
</Steps>
