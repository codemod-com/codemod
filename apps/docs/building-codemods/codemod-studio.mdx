...
<Step title="Add before/after snippets">
  ...
  2. or you can use the [`codemod learn`](/deploying-codemods/cli#generate-codemod-from-file-diff) command straight from your IDE/CLI to automatically populate the before/after snippets.
  </Step>
...
2. [run the codemod using Codemod CLI](/deploying-codemods/cli#running-codemods).