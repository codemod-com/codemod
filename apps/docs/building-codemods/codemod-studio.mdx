...
<Steps>
  <Step title="Export codemod">
    Click `Run locally via CLI` to export and download the [codemod package](/codemod-registry/introduction#required-codemod-package-structure).
  </Step>
