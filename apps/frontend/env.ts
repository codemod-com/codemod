...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_CODEMOD_AUTOMATIONS_LIST_ENDPOINT_OLD: z.string(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_CODEMOD_AUTOMATIONS_LIST_ENDPOINT_OLD:
      process.env.NEXT_PUBLIC_CODEMOD_AUTOMATIONS_LIST_ENDPOINT_OLD,
