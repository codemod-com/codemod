...
export const mockGithubRepositories: GithubRepository[] = [
  {
    id: 1,
    name: "vercel-hydrogen-demo-store",
  ...
  {
    id: 2,
    name: "eslint-plugin-better-styled-components",
  ...
  {
    id: 5,
    name: "drag-and-drop-article12345",
    full_name: "mockUser/fail",
    private: true,
    html_url: "fail",
    default_branch: "master",
