...
import {
  ...
  migrationPrData,
  prsMergedData,
} from "@/app/(website)/campaigns/[campaignId]/mockData";
import {
  HeroTable,
  MergedPRsCard,
  PrTable,
  ReviewTimeCard,
  TimeSavedCard,
} from "@/app/(website)/campaigns/[campaignId]/widgets";
import { CustomChart } from "@/app/(website)/campaigns/[campaignId]/widgets/CustomChart";
import { CustomTable } from "@/app/(website)/campaigns/[campaignId]/widgets/CustomTable";
import { DepreciatedAPIChart } from "@/app/(website)/campaigns/[campaignId]/widgets/DepreciatedAPIChart";
import { PrsMergedChart } from "@/app/(website)/campaigns/[campaignId]/widgets/PrsMergedChart";
