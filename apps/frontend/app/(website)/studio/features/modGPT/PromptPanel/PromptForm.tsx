...
import { ArrowElbowDownLeft as ArrowElbowDownLeftIcon, Trash as TrashIcon, } from "@phosphor-icons/react";
...
export const PromptForm = React.forwardRef<HTMLTextAreaElement, Props>(
	({ onSubmit, onReset, input, setInput, isLoading }, ref) => {
		...
		return (
			...
			>
				<div
					className="max-h-60 relative flex w-full grow items-center overflow-hidden bg-background pl-8 sm:rounded-md sm:border sm:pl-12">
					<Tooltip
						trigger={
							<button
								type="button"
