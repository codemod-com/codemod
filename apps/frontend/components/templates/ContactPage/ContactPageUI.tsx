            ...
            >
              ...
              {formState === "error" ? (
                <div className="mt-8 flex items-center gap-xs rounded-[8px] bg-errorSecondary-light p-xs dark:bg-errorSecondary-dark">
                  ...
                  <img src="/icons/error-info.svg" alt={t('warning-info-icon-1')} />
          ...
          >
            ...
            >
              ...
              {formState === "error" ? (
                <div className="mt-8 flex items-center gap-xs rounded-[8px] bg-errorSecondary-light p-xs dark:bg-errorSecondary-dark">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icons/error-info.svg" alt={t('warning-info-icon-2')} />
      ...
      {formState === "success" ? (
        <>
          ...
          >
            ...
            <div className="body-l">{t('we-will-get-back-to-you-1')}</div>
          ...
          >
            ...
            <div className="body-l">{t('we-will-get-back-to-you-2')}</div>
            <LinkButton intent="primary" className="mt-l" arrow href="/">
