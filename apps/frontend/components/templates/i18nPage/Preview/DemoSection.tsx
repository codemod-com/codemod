  ...
  return (
    <>
      <div className="relative z-[60] w-full max-w-full">
        <aside className="sticky top-6 z-[200] md:absolute md:-bottom-10 md:-right-0 md:top-auto md:w-72 border border-border-light dark:border-border-dark rounded-xl overflow-hidden">
        ...
        >
          ...
          <div className="relative order-2 flex flex-col overflow-hidden rounded-l md:order-1 md:w-[40%]">
            <Code step={step} isAnimating={isAnimating} setStep={setStep} />
          </div>
