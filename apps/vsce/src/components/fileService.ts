...
export class FileService {
	...
	public async createFile(params: {
		...
		let content = await workspace.fs.readFile(params.newContentUri);

		let directory = dirname(params.newUri.fsPath);
	...
	public async updateFile(params: {
		...
		let content = await workspace.fs.readFile(params.contentUri);
