...
export let CodemodRuns = (
	props: MainWebviewViewProps & {
		activeTabId: 'codemodRuns';
		screenWidth: number | null;
	},
) => {
	let resultsRef = useRef<ImperativePanelHandle | null>(null);
	let changeExplorerRef = useRef<ImperativePanelHandle | null>(null);
	...
	let commands: (Command & { icon: string })[] = [];
