...
let setSearchPhrase = (caseHashDigest: CaseHash, searchPhrase: string) => {
	vscode.postMessage({
...
let onCollapsibleExplorerNodeFlip = (
	caseHashDigest: CaseHash,
	explorerNodeHashDigest: _ExplorerNodeHashDigest,
) => {
	vscode.postMessage({
...
export let App = (
	...
	let { changeExplorerTree, codemodExecutionInProgress } = props;
	let progress = useProgressBar();
	let caseHash = changeExplorerTree?.caseHash ?? null;
