...
def send_prompt_to_model(codemod_alternatives, prompts_thread, llm_engine, codemod_engine):
    messages = [{"role": "system", "content": configs.get_codemod_engine(codemod_engine).system_instructions},
